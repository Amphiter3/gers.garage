...
--
-- Host: localhost:8889
-- Generation Time: Feb 02, 2020 at 09:46 PM
...
(1, 6, 1, '121D12345', 1, 1, 3, 2, 'test1', 3),
...
(76, 9, 10, 'aas6465645', 3, 1, 76, 3, '', 2),
(77, 10, 14, 'aas6465645', 3, 2, 77, NULL, '', 1),
(78, 10, 14, 'aas6465645', 3, 3, 78, NULL, 'efishwvsv', 1),
(79, 11, 40, 'aas646242', 3, 4, 79, NULL, '', 1),
(80, 10, 14, 'aas6465645', 3, 1, 80, NULL, 'test', 1),
(81, 10, 14, 'aas6465645', 3, 2, 81, NULL, '', 1),
(82, 12, 37, '34567890', 3, 2, 82, NULL, '', 1);
...
(1, 'Mechanic1', 'M_lastname1'),
(2, 'Mechanic2', 'M_lastname2'),
(3, 'Mechanic3', 'M_lastname3'),
(4, 'Mechanic4', 'M_lastname4');
...
(12, 'Duxback - Windscreen\r\n', 'Revolutionary glass treatment', 30),
(15, 'Cataclean', 'Exhaust system cleaner', 25),
(16, 'Cambelt Replacement', 'Cambelt Replacement', 170),
(17, 'Air Conditioning', 'Antibacterial Clean', 25),
(18, 'Coolant/Antifreeze Change', 'Coolant/Antifreeze Change', 45),
(19, 'Wheel balancing', 'Wheel balancing', 10),
(20, 'Wheel alignment (Tracking)', 'Correct wheel alignment', 35),
...
(28, 'Puncture Repair', 'Puncture Repair', 30),
(29, 'AdBlue Top-Up', 'AdBlue Top-Up', 25),
...
(1, 'Annual Service', 'The Annual Service is among the most comprehensive services available, comprising 75 individual maintenance checks. It exceeds the recommendations made by most manufacturers of checks, refills and replacements to be performed annually and will help ensure trouble-free motoring.', 200, 1),
(2, 'Major Service', 'The Major Service is our most comprehensive car service which includes everything needed in an Annual Service. In addition, we change parts recommended for replacement every two years including a brake fluid change, and a cabin filter replacement. This Service should be carried out every other year, in place of an Annual Service.\r\n', 350, 1),
(3, 'Repair / Fault', 'Car clutch feel unusual or you\'re hearing noises when changing gears? Book a repair / fault inspection at Ger\'s Garage today. We\'ll always give you a full quote before we start work. We\'ll even show you the problem part before we fix it.', 50, 1),
(4, 'Major Repair', 'We use state-of-the-art car diagnostic test equipment and our high-level technical training means we can make sense of baffling fault codes and advise on any necessary repairs. You\'ll always pay a great price for our comprehensive vehicle diagnostics check - and the peace of mind is priceless.', 0, 2);
...
(12, 1, 'mihaela', 'Mihaela', '0873969200', 37, '34567890', 3, 'annacucos@gmail.com', 'annacucos'),
(11, 1, 'miha', 'c', '08723123512', 40, 'aas646242', 3, 'c.m@gmail.com', '12345'),
(9, 1, 'mihaela', 'cucos', '0873969200', 10, 'aas6465645', 3, 'cucos.mihaela@gmail.com', '1234567'),
(10, 1, 'miki', 'cucos', '0873969200', 14, 'aas6465645', 3, 'cucos@gmail.com', '12345'),
(6, 1, 'example', 'example', '0899778784', 2, '54321DS', 1, 'example@gmail.com', '12345'),
(2, 2, 'Ger', 'Owner', '1234567890', NULL, '', NULL, 'ger@gersgarage.com', '12345'),
(7, 1, 'user1', 'user1', '0838883381', 2, '987654321', 3, 'j.o@gmail.com', '12345'),
(8, 1, 'Maria', 'Codreanu', '23232323233', 19, '54321', 3, 'maria@gmail.com', '12345');
...
--
ALTER TABLE `parts_n_invoice`
  MODIFY `parts_n_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `slots`
  MODIFY `slot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
