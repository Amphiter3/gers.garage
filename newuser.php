...
$cat3=$_GET['cat3']; // If your global variable is off
...
<h3>USER INFORMATION</h3><br>
    ...
    <input type="text" class="form-control"  onkeypress="testNumber(event)" placeholder="Format 0871230000" name="mobile" id="mobile" required>
...
<br>
    ...
    <button type="submit" class="btn btn-succes" value="enter" id="enter" name="enter" style="font-size: medium;">REGISTER</button>
    </div>
  </div>
