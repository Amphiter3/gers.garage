...
if($total_rows == 0){
    ...
    echo "<div align='right'><button class='btn btn-primary save' onclick=\"window.location.href = '.php';\"  style=\"font-size: medium; height: 33.5px; width: 120px;\">BACK</button></div>";
}else{
