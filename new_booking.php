...
echo '<br><h2><b>Step 1/3:</b> Choose a service for your vehicle</h2><br>';
...
<div id="first">
<h2>Step 2/3: Pick the Date of your service</h2>
<p>*The garage doesn\'t work on Sundays</p><br>
<h5>Date:</h5><input type="text" class="date readonly" id="datep" name="datep" autocomplete="off" required/>
</div>';
               echo "</div>";
               echo "</div>";
               echo "<div align='right'>
               <a href='home.php' class='btn btn-secondary cancel' style='font-size: medium; height: 33.5px; width: 120px;'>CANCEL</a>&nbsp;&nbsp;
               <button type='submit' class='btn btn-primary save' style='font-size: medium;'>CONTINUE</button></div>";
               echo '</form>'; 
